...
def test_get_number_from_index():
    assert get_number_from_index(read_schematic(["617.*..534.."]), 0, 0) == (
        617,
        [0, 1, 2],
    )
    assert get_number_from_index(read_schematic(["617.*..534.."]), 0, 1) == (
        617,
        [0, 1, 2],
    )
    assert get_number_from_index(read_schematic(["617.*..534.."]), 0, 2) == (
        617,
        [0, 1, 2],
    )
    assert get_number_from_index(read_schematic(["617.*..534.."]), 0, 7) == (
        534,
        [7, 8, 9],
    )
    assert get_number_from_index(read_schematic(["617.*..534.."]), 0, 8) == (
        534,
        [7, 8, 9],
    )
    assert get_number_from_index(read_schematic(["617.*..534.."]), 0, 9) == (
        534,
        [7, 8, 9],
    )
...
.664.598..""".splitlines()
    ...
    assert sum_part_numbers(schematic=schematic) == 467835
